<%-- 
    ...
    Created on : 23-May-2018, 19:37:01
    Author     : Alex
--%>
            ...
            <div class="container"><a class="navbar-brand" href="../index.html" style="color:#ffffff;">Aloitelaatikko</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item" role="presentation"><a class="nav-link active" href="#">Poista aloite</a></li>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <form action="../../pahvilaatikko/poistaAloite" method="post"><input class="form-control" type="text" name="aloiteID" placeholder="Aloite ID"><button class="btn btn-primary" type="submit" id="nappi" style="background-color:#007ac9;">Poista Aloite</button><button class="btn btn-primary" type="reset"
