<%-- 
    ...
    Created on : 23-May-2018, 19:32:19
    Author     : Alex
--%>
                ...
                <div class="container"><a class="navbar-brand" href="../index.html" style="color:#ffffff;">Aloitelaatikko</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div
                        ...
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item" role="presentation"><a class="nav-link active" href="#">Lisaa käyttäjä</a></li>
        ...
        <div class="highlight-phone">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="intro">
                            <h2>Uuden käyttäjän lisäys:</h2>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <form action="../../pahvilaatikko/lisaaKayttaja" method="post"><input class="form-control" type="text" name="etunimi" placeholder="Etunimi"><input class="form-control" type="text" name="sukunimi" placeholder="Sukunimi"><input class="form-control" type="email" name="email" placeholder="Sähköposti">
                                <input
                                    class="form-control" type="text" name="kayttajatunnus" placeholder="Käyttäjätunnus"><input class="form-control" type="password" name="salasana" placeholder="Salasana"><input class="form-control" type="tel" name="puhelin" placeholder="puhelin"><button class="btn btn-primary" type="submit" id="nappi" style="background-color:#007ac9;">Tallenna käyttäjä</button>
                                <button
                                    class="btn btn-primary" type="reset" id="nappi" style="background-color:#007ac9;">Tyhjennä</button>
                            </form>
                        </div>
                    </div>
                </div>
