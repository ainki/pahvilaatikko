<%-- 
    ...
    Created on : 23-May-2018, 19:30:29
    Author     : Alex
--%>
            ...
            <div class="container"><a class="navbar-brand" href="../index.html" style="color:#ffffff;">Aloitelaatikko</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item" role="presentation"><a class="nav-link active" href="#">Lisaa aloite</a></li>
    ...
    <div class="highlight-phone">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="intro">
                        <h2>Uuden aloitteen lisäys:</h2>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <form action="../../pahvilaatikko/lisaaAloite" method="post"><input class="form-control" type="text" name="kayttajaID" placeholder="Käyttäjän ID"><input class="form-control" type="text" name="aloitenimi" placeholder="Aloitteen nimi"><textarea class="form-control" rows="6" name="aloitekuvaus"
                                placeholder="Aloitteen kuvaus"></textarea><button class="btn btn-primary" type="submit" id="nappi" style="background-color:#007ac9;">Talleta aloite</button><button class="btn btn-primary" type="reset" id="nappi" style="background-color:#007ac9;">Tyhjennä</button></form>
                    </div>
                </div>
            </div>
        </div>
